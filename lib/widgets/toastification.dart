...
class ToastHelper {
  ...
  static void showToast({
    ...
    toastification.show(
      ...
      description: Text(message, style: TextStyle(fontSize: 15.sp)),
  ...
  static void showErrorToast(String message) {
    ...
    toastification.show(
      ...
      alignment: Alignment.topRight,
      icon: Icon(
        getIcon(ToastificationType.error),
        color: getIconColor(ToastificationType.error),
        size: 15.sp,
      ),
      showIcon: true,
  ...
  static void showSuccessToast(String message) {
    ...
    toastification.show(
      ...
      autoCloseDuration: const Duration(seconds: 3),
      title: Text(
        getTitle(ToastificationType.success),
        style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15.sp),
      ),
      description: Text(message, style: TextStyle(fontSize: 15.sp)),
      alignment: Alignment.topRight,
      icon: Icon(
        getIcon(ToastificationType.success),
        color: getIconColor(ToastificationType.success),
        size: 15.sp,
      ),
      showIcon: true,
      primaryColor: getPrimaryColor(ToastificationType.success),
      backgroundColor: Colors.white,
      foregroundColor: Colors.black,
      borderRadius: BorderRadius.circular(10.sp),
      padding: EdgeInsets.symmetric(horizontal: 10.sp, vertical: 6.sp),
